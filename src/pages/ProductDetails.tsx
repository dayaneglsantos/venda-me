...
export default function ProductDetails() {
  ...
  return (
    <div className="p-6 pt-3 max-w-7xl mx-auto w-full">
      <div className="flex items-center justify-between mb-4">
        ...
        {user && user.id === seller?.id && (
          <div className="flex gap-2">
            <Tooltip id="edit-tooltip" place="top" className="p-0! text-xs!" />
            <div
              className="p-1.5 rounded-full bg-gray-100 text-xl cursor-pointer text-primary-dark"
              ...
              <>
                ...
                >
                  <FiPauseCircle
                    ...
                    data-tooltip-content="Pausar Anúncio"
                  />
                </div>
              </>
            )}
              ...
              <>
                ...
                >
                  <FiPlayCircle
                    ...
                    data-tooltip-content="Reativar Anúncio"
                  />
                </div>
              </>
            )}
              ...
              <>
                ...
                >
                  <FiCheckCircle
                    ...
                    data-tooltip-content="Marcar como Vendido"
                  />
                </div>
              </>
            )}
        ...
        <div className="flex flex-col gap-3">
          <div className="rounded-xl overflow-hidden shadow-md bg-white">
            <Swiper
              ...
              style={
                {
                  "--swiper-navigation-color": "#ee8128",
                  "--swiper-pagination-color": "#ee8128",
        ...
        <div className="flex flex-col gap-4">
          <div className="bg-white rounded-xl shadow-md p-5 flex flex-col gap-3 border border-gray-200">
            ...
            <p className="text-xs text-gray-400 mt-1">
              Publicado em{" "}
              {dayjs(product.createdAt).format("DD/MM/YYYY [às] HH:mm")}
            </p>
          </div>
        </div>
      </div>
